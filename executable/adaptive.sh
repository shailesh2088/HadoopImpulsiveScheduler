echo "Running Adaptive Scheduler"
...
cp $HOME/adaptive/hadoop-site.xml-adaptive $HADOOP_HOME/conf/hadoop-site.xml

#$HADOOP_HOME/bin/hadoop jar hadoop-0.20.2-examples.jar pi 10 1000000

#$HADOOP_HOME/bin/hadoop jar /root/adaptive/experiments/cloud9-1.1.1.jar edu.umd.cloud9.example.bigram.BigramCount data/bible+shakes.nopunc bigram 500
...
echo "Finished Running Adaptive Scheduler"
